...
public class JoinExample {
    public static void main(String[] args) {
        ...
        try {
            th2.join(); // It does this by holding the main thread here until th2 is complete
        } catch (InterruptedException ie) {
            ie.printStackTrace();
        }
        th3.start();
        ...
        try {
            th3.join(); // It does this by holding the main thread here until th3 is complete
        } catch (InterruptedException ie) {
            ie.printStackTrace();
        }
